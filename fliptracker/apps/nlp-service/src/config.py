...
class Settings(BaseSettings):
    ...
    cls_marketplace_labels_path: str = str(
        model_base / "cls_marketplace" / "label_map.json"
    )
    cls_email_type_labels_path: str = str(
        model_base / "cls_email_type" / "label_map.json"
    )
